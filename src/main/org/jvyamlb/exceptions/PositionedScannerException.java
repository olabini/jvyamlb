...
public class PositionedScannerException extends ScannerException implements Positionable {
    ...
    public PositionedScannerException(final String when, final String what, final String note, final Position.Range range) {
        super(when, what, note);
        assert range != null;
        this.range = range;
    }

    public PositionedScannerException(final Throwable thr, final Position.Range range) {
        super(thr);
        assert range != null;
        this.range = range;
    }
